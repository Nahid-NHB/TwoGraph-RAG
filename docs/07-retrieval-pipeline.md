...
The same report documents the caching speedup (issue #71): `caching.graphQuerySpeedupX` compares a cold `GraphQueries` read against a cached repeat of the exact same call.
